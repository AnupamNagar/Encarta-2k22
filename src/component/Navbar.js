...
function Navbar() {
  return (
    <div className='  flex justify-between py-6 px-4'>
      <div className=''>
       <Link to='/'><img src={logo} className='w-8 md:w-12 rounded-3xl  cursor-pointer hover:scale-110 ' alt='/' ></img></Link> 
      </div> 
      <div>
        ...
        <li className='hover:scale-110 '><Link to='/contact'>Contact US</Link></li>
        <li className='hover:scale-110'><Link to='/signup'>Register</Link></li>
      </ul>
